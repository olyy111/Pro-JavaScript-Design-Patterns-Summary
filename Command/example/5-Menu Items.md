the receiver classes and the methods they implement.
![image](F2AD3332AA3842819E4E9C67A7160919)


You will build a class for creating desktop app–style menu bars, and
use command objects to allow these menus to perform a wide variety of actions.
```javascript
...
//If the action method uses the this keyword internally, 
//it has to be wrapped in an anonymous function
